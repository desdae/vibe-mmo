...
const runtimeBootstrap = createRuntimeBootstrap({
  ...
  stateBroadcastDeps: {
    ...
    mobs,
    lootBags,
    rebuildSpatialIndexes: worldState.rebuildSpatialIndexes,
    getPlayersInRadius: worldState.getPlayersInRadius,
    getProjectilesInRadius: worldState.getProjectilesInRadius,
    getMobsInRadius: worldState.getMobsInRadius,
    getLootBagsInRadius: worldState.getLootBagsInRadius,
    VISIBILITY_RANGE,
    getPlayerVisibilityExtents,
    inVisibilityRange,
    serializePlayer,
